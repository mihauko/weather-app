...
const featureText: FeatureText[] = [
  {
    ...
    title: 'FrontendMe Michał Winiarski Buisness Page',
    href: '/',
    description:
      'Zaprojektuję i zbuduję dla Ciebie nowoczesną stronę internetową, która przyciągnie klientów i pomoże w rozwoju Twojego biznesu. Skontaktuj się ze mną, a wspólnie stworzymy coś wyjątkowego!',
    cta: 'Learn More',
  },
  {
    icon: <Coins className="h-6 w-6" />,
